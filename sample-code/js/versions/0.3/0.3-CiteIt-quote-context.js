 ...
 * Citeit.net Quote-Context JS Library
 *
...
hidden_container = "citeit_container";	// div in footer than holds injected json data, requires css class to hide
...
function normalize_text(str, replace_chars_array){
  /*	This javascript function performs the same functionality as the python method: 
		citeit_quote_context.utility.text.normalize()
